  ...
  try {
    ...
    root.style.background =
      theme === "dark"
        ...
        : "radial-gradient(ellipse 90% 60% at 100% -10%, rgba(14,165,233,0.28), transparent 55%), radial-gradient(ellipse 70% 50% at 0% 0%, rgba(125,211,252,0.22), transparent 50%), linear-gradient(180deg, #ffffff 0%, #f0f9ff 42%, #e0f2fe 100%)";
