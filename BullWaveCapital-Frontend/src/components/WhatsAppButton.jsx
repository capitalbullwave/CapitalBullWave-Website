...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed z-[9998] group right-4 sm:right-6 bottom-[calc(5.75rem+env(safe-area-inset-bottom,0px))] sm:bottom-[calc(7rem+env(safe-area-inset-bottom,0px))]"
    >
      ...
      <div className="relative flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-green-500/50">
