...
export default function HomeDirector({ theme = "light" }) {
  ...
  return (
    <section
      className={`home-director relative w-full overflow-hidden py-12 sm:py-16 lg:py-22 ${
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center sm:mb-10 lg:mb-12">
          <span
            className={`home-director__badge inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold tracking-wide sm:text-sm ${
              dark
          ...
          <h2
            ...
            className={`mt-4 text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl ${
        ...
        <div className="home-director__panel grid grid-cols-1 items-stretch gap-8 lg:grid-cols-12 lg:gap-10 xl:gap-12">
          {/* Portrait */}
          <div className="home-director__photo-wrap relative mx-auto w-full max-w-md lg:col-span-5 lg:mx-0 lg:max-w-none lg:self-center">
            ...
            <div className="home-director__photo-frame relative overflow-hidden">
              ...
              <div className="home-director__photo-caption">
                <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-sky-200/90 sm:text-xs">
                  Director
                </p>
          ...
          <div className="flex min-w-0 flex-col justify-center lg:col-span-7">
            ...
            <h3
              className={`mt-2 text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-[2.75rem] lg:leading-tight ${
                dark ? "text-white" : "text-slate-900"
              }`}
            >
              Rohit{" "}
              <span
                className={`home-director__name-accent ${
                  dark ? "text-sky-400" : "text-sky-600"
                }`}
              >
                Jaiswal
            ...
            <blockquote
              className={`home-director__quote mt-5 text-sm leading-relaxed sm:mt-6 sm:text-base lg:text-[1.05rem] lg:leading-8 ${
            ...
            <p
              className={`home-director__sign mt-4 text-right text-lg sm:text-xl ${
            ...
            <ul className="mt-6 grid grid-cols-1 gap-3 sm:mt-8 sm:grid-cols-2 sm:gap-3.5">
              {HIGHLIGHTS.map((item) => (
                <li
                  key={item.title}
                  className={`home-director__chip flex items-start gap-3 rounded-xl px-3.5 py-3.5 sm:px-4 ${
                    dark
                ...
                >
                  <span
                    className={`mt-0.5 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-sm font-bold ${
                      dark
                  ...
                  <span className="min-w-0">
                    ...
                    <span
                      className={`mt-0.5 block text-xs leading-snug sm:text-[13px] ${
