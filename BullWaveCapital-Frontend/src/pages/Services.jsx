    ...
    <section className="mx-auto my-8 max-w-7xl px-6 sm:px-8 lg:px-12">
      <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white/95 p-6 shadow-[0_30px_60px_rgba(15,23,42,0.08)] transition-colors duration-300 sm:p-8 lg:p-10">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <article className="rounded-[28px] border border-slate-200 bg-slate-50 p-8 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-sky-400 hover:border-2 hover:shadow-lg">
            <h2 className="text-2xl font-semibold underline text-blue-700">Core Plan</h2>
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-sky-400 hover:border-2 hover:shadow-lg">
            <h2 className="text-2xl font-semibold underline text-blue-700">Elite Plan</h2>
            <p className="mt-4 text-slate-600 leading-7">
